		...
		_applyEvents: function () {
			...
			setInterval(function() {
				...
				if(monthSize * 6 < calendarSize) {
					monthContainerClass += ' col-xs-2 col-md-2';
				}
				else if(monthSize * 4 < calendarSize) {
					monthContainerClass += ' col-xs-3 col-md-3';
				}
				else if(monthSize * 3 < calendarSize) {
					monthContainerClass += ' col-xs-4 col-md-4';
				}
				else if(monthSize * 2 < calendarSize) {
					monthContainerClass += ' col-xs-6 col-md-6';
				}
				else {
					monthContainerClass += ' col-xs-12 col-md-12';
				}
